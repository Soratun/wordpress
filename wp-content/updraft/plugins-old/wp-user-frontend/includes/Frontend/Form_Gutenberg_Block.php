...
class Form_Gutenberg_Block {
    ...
    public function wpuf_form_block() {
        ...
        wp_register_script( 'wpuf-forms-block', $js_dir . 'gutenblock.js',
            [ 'wp-blocks', 'wp-editor', 'wp-components', 'wp-i18n', 'wp-element', 'underscore' ], WPUF_VERSION );
        wp_register_style( 'wpuf-forms-block-style', $css_dir . 'gutenblock.css', [ 'wp-edit-blocks' ], WPUF_VERSION );
        wp_register_style( 'wpuf-forms-block-editor', $css_dir . 'gutenblock-editor.css',
            [ 'wp-edit-blocks', 'wpuf-forms-block-style' ], WPUF_VERSION );
        /*
    ...
    public function load_preview_data() {
        ...
        if ( isset( $_GET['wpuf_preview'] ) && isset( $_GET['wpuf_iframe'] ) ) {
            ...
            wp_register_script( 'wpuf-block-setup', $js_dir . 'blockFrameSetup.js', [ 'underscore', 'jquery' ] );
