...
class Admin_Template {
    ...
    public static function legend( $title = 'Field Name', $values = [], $field_id = 0 ) {
        ...
        <div class="wpuf-legend" title="<?php esc_html_e( 'Click and Drag to rearrange', 'wp-user-frontend' ); ?>">
            <input type="hidden" value="<?php echo esc_attr( $id ); ?>"
                   name="wpuf_input[<?php echo esc_attr( $field_id ); ?>][id]">
    ...
    public static function common( $id, $field_name_value = '', $custom_field = true, $values = [] ) {
        ...
        <div class="wpuf-form-rows required-field">
            ...
            <div class="wpuf-form-sub-fields">
                <label><input type="radio" name="<?php echo esc_attr( $required_name ); ?>" value="yes"<?php checked(
                        $required, 'yes'
                    ); ?>> <?php esc_html_e( 'Yes', 'wp-user-frontend' ); ?> </label>
                <label><input type="radio" name="<?php echo esc_attr( $required_name ); ?>" value="no"<?php checked(
                        $required, 'no'
                    ); ?>> <?php esc_html_e( 'No', 'wp-user-frontend' ); ?> </label>
            </div>
        </div> <!-- .wpuf-form-rows -->

        <div class="wpuf-form-rows">
            <label><?php esc_html_e( 'Field Label', 'wp-user-frontend' ); ?></label>
            <input type="text" data-type="label" name="<?php echo esc_attr( $label_name ); ?>"
                   value="<?php echo esc_attr( $label_value ); ?>" class="smallipopInput"
                   title="<?php esc_html_e( 'Enter a title of this field', 'wp-user-frontend' ); ?>">
        </div> <!-- .wpuf-form-rows -->

        <?php if ( $custom_field ) { ?>
            <div class="wpuf-form-rows">
                <label><?php esc_html_e( 'Meta Key', 'wp-user-frontend' ); ?></label>
                <input type="text" data-type="name" name="<?php echo esc_attr( $field_name ); ?>"
                       value="<?php echo esc_attr( $field_name_value ); ?>" class="smallipopInput"
                       title="<?php esc_html_e(
                           'Name of the meta key this field will save to', 'wp-user-frontend'
                       ); ?>">
                <input type="hidden" name="<?php echo esc_attr( $is_meta_name ); ?>" value="yes">
            </div> <!-- .wpuf-form-rows -->
        <?php } else { ?>

            <input type="hidden" data-type="name" name="<?php echo esc_attr( $field_name ); ?>"
                   value="<?php echo esc_attr( $field_name_value ); ?>">
        ...
        <div class="wpuf-form-rows">
            ...
            <textarea name="<?php echo esc_attr( $help_name ); ?>" class="smallipopInput" title="<?php esc_html_e(
                'Give the user some information about this field', 'wp-user-frontend'
            ); ?>"><?php echo esc_attr( $help_value ); ?></textarea>
        </div> <!-- .wpuf-form-rows -->

        <div class="wpuf-form-rows">
            <label><?php esc_html_e( 'CSS Class Name', 'wp-user-frontend' ); ?></label>
            <input type="text" name="<?php echo esc_attr( $css_name ); ?>" value="<?php echo esc_attr( $css_value ); ?>"
                   class="smallipopInput"
                   title="<?php esc_html_e( 'Add a CSS class name for this field', 'wp-user-frontend' ); ?>">
        </div> <!-- .wpuf-form-rows -->
    ...
    public static function common_text( $id, $values = [] ) {
        ...
        <div class="wpuf-form-rows">
            ...
            <input type="text" class="smallipopInput" name="<?php echo esc_attr( $placeholder_name ); ?>"
                   title="<?php esc_attr_e( 'Text for HTML5 placeholder attribute', 'wp-user-frontend' ); ?>"
                   value="<?php echo esc_attr( $placeholder_value ); ?>"/>
        </div> <!-- .wpuf-form-rows -->

        <div class="wpuf-form-rows">
            <label><?php esc_html_e( 'Default value', 'wp-user-frontend' ); ?></label>
            <input type="text" class="smallipopInput" name="<?php echo esc_attr( $default_name ); ?>"
                   title="<?php esc_attr_e( 'The default value this field will have', 'wp-user-frontend' ); ?>"
                   value="<?php echo esc_attr( $default_value ); ?>"/>
        </div> <!-- .wpuf-form-rows -->

        <div class="wpuf-form-rows">
            <label><?php esc_html_e( 'Size', 'wp-user-frontend' ); ?></label>
            <input type="text" class="smallipopInput" name="<?php echo esc_attr( $size_name ); ?>"
                   title="<?php esc_attr_e( 'Size of this input field', 'wp-user-frontend' ); ?>"
    ...
    public static function common_textarea( $id, $values = [] ) {
        ...
        <div class="wpuf-form-rows">
            ...
            <input type="text" class="smallipopInput" name="<?php echo esc_attr( $rows_name ); ?>"
                   title="Number of rows in textarea" value="<?php echo esc_attr( $rows_value ); ?>"/>
        </div> <!-- .wpuf-form-rows -->

        <div class="wpuf-form-rows">
            <label><?php esc_html_e( 'Columns', 'wp-user-frontend' ); ?></label>
            <input type="text" class="smallipopInput" name="<?php echo esc_attr( $cols_name ); ?>"
                   title="Number of columns in textarea" value="<?php echo esc_attr( $cols_value ); ?>"/>
        </div> <!-- .wpuf-form-rows -->

        <div class="wpuf-form-rows">
            <label><?php esc_html_e( 'Placeholder text', 'wp-user-frontend' ); ?></label>
            <input type="text" class="smallipopInput" name="<?php echo esc_attr( $placeholder_name ); ?>"
                   title="text for HTML5 placeholder attribute" value="<?php echo esc_attr( $placeholder_value ); ?>"/>
        </div> <!-- .wpuf-form-rows -->

        <div class="wpuf-form-rows">
            <label><?php esc_html_e( 'Default value', 'wp-user-frontend' ); ?></label>
            <input type="text" class="smallipopInput" name="<?php echo esc_attr( $default_name ); ?>"
                   title="the default value this field will have" value="<?php echo esc_attr( $default_value ); ?>"/>
        </div> <!-- .wpuf-form-rows -->
        ...
        <div class="wpuf-form-rows">
            ...
            <div class="wpuf-form-sub-fields">
                <label><input type="radio" name="<?php echo esc_attr( $rich_name ); ?>" value="no"<?php checked(
                        $rich_value, 'no'
                    ); ?>> <?php esc_html_e( 'Normal', 'wp-user-frontend' ); ?></label>
                <label><input type="radio" name="<?php echo esc_attr( $rich_name ); ?>" value="yes"<?php checked(
                        $rich_value, 'yes'
                    ); ?>> <?php esc_html_e( 'Rich textarea', 'wp-user-frontend' ); ?></label>
                <label><input type="radio" name="<?php echo esc_attr( $rich_name ); ?>" value="teeny"<?php checked(
                        $rich_value, 'teeny'
                    ); ?>> <?php esc_html_e( 'Teeny Rich textarea', 'wp-user-frontend' ); ?></label>
            </div>
        </div> <!-- .wpuf-form-rows -->
    ...
    public static function hidden_field( $name, $value = '' ) {
        printf(
            '<input type="hidden" name="%s" value="%s" />', esc_attr( self::$input_name ) . esc_attr( $name ),
            esc_attr( $value )
        );
    }
    ...
    public static function radio_fields( $field_id, $name, $values = [] ) {
        ...
        <label for="wpuf-<?php echo esc_attr( $name . '_' . $field_id ); ?>" class="wpuf-show-field-value">
            <input type="checkbox" class="wpuf-value-handelar"
                   id="wpuf-<?php echo esc_attr( $name . '_' . $field_id ); ?>"><?php esc_html_e(
                'Show values', 'wp-user-frontend'
            ); ?>
        </label>

        <div class="wpuf-option-label-value"><span><?php esc_html_e( 'Label', 'wp-user-frontend' ); ?></span><span
                class="wpuf-option-value" style="display: none;"><?php esc_html_e(
                    'Value', 'wp-user-frontend'
                ); ?></span></div>
        <?php
            ...
            foreach ( $values['options'] as $key => $value ) {
                ...
                <div class="wpuf-clone-field">
                    <input type="radio" name="<?php echo esc_attr( $selected_name ); ?>"
                           value="<?php echo esc_attr( $value ); ?>" <?php checked( $selected_value, $value ); ?>>
                    <input type="text" data-type="option" name="<?php echo esc_attr( $input_name ); ?>[]"
                           value="<?php echo esc_attr( $value ); ?>">
                    <input type="text" data-type="option_value" name="<?php echo esc_attr( $input_value_name ); ?>[]"
                           value="<?php echo esc_attr( $key ); ?>" style="display:none;">
    ...
    public static function common_checkbox( $field_id, $name, $values = [] ) {
        ...
        <input type="checkbox" class="wpuf-value-handelar" id="<?php echo esc_attr( $name . '_' . $field_id ); ?>">
        <label for="<?php echo esc_attr( $name . '_' . $field_id ); ?>"><?php esc_html_e(
                'show values', 'wp-user-frontend'
            ); ?></label>
        <div class="wpuf-option-label-value"><span><?php esc_html_e( 'Label', 'wp-user-frontend' ); ?></span><span
                class="wpuf-option-value" style="display: none;"><?php esc_html_e(
            ...
            foreach ( $values['options'] as $key => $value ) {
                ...
                <div class="wpuf-clone-field">
                    ...
                    <input type="checkbox" name="<?php echo esc_attr( $selected_name ); ?>[]"
                           value="<?php echo esc_attr( $value ); ?>"<?php echo in_array(
    ...
    public static function remove_button() {
        ...
        <img style="cursor:pointer; margin:0 3px;" alt="add another choice" title="add another choice"
             class="wpuf-clone-field" src="<?php echo esc_attr( $add ); ?>">
        <img style="cursor:pointer;" class="wpuf-remove-field" alt="remove this choice" title="remove this choice"
             src="<?php echo esc_attr( $remove ); ?>">
        <?php
    }
        ...
        <li class="custom-field dropdown_field wpuf-conditional">
            ...
            <div class="wpuf-form-holder">
                ...
                <div class="wpuf-form-rows">
                    ...
                    <input type="text" class="smallipopInput" name="<?php echo esc_attr( $first_name ); ?>"
                           value="<?php echo esc_attr( $first_value ); ?>" title="<?php echo esc_attr( $help ); ?>">
                </div> <!-- .wpuf-form-rows -->
    ...
    public static function custom_hidden_field( $field_id, $label, $values = [] ) {
        ...
        <li class="custom-field custom_hidden_field">
            ...
            <div class="wpuf-form-holder">
                <div class="wpuf-form-rows">
                    <label><?php esc_html_e( 'Meta Key', 'wp-user-frontend' ); ?></label>
                    <input type="text" name="<?php echo esc_attr( $meta_name ); ?>"
                           value="<?php echo esc_attr( $meta_value ); ?>" class="smallipopInput"
                           title="<?php esc_html_e(
                               'Name of the meta key this field will save to', 'wp-user-frontend'
                           ); ?>">
                    <input type="hidden" name="<?php echo esc_attr( $is_meta_name ); ?>" value="yes">
                ...
                <div class="wpuf-form-rows">
                    ...
                    <input type="text" class="smallipopInput"
                           title="<?php esc_attr_e( 'Enter the meta value', 'wp-user-frontend' ); ?>"
                           name="<?php echo esc_attr( $value_name ); ?>"
                           value="<?php echo esc_attr( $value_value ); ?>">
                </div>
            </div> <!-- .wpuf-form-holder -->
        </li>
        <?php
        ...
        <li class="custom-field custom_html">
            ...
            <div class="wpuf-form-holder">
                ...
                <div class="wpuf-form-rows">
                    ...
                    <textarea class="smallipopInput" title="Some details text about the section"
                              name="<?php echo esc_attr( $description_name ); ?>" rows="3"><?php echo esc_html(
                            $description_value
                        ); ?></textarea>
                </div> <!-- .wpuf-form-rows -->
        ...
        <li class="custom-field image_upload">
            ...
            <div class="wpuf-form-holder">
                ...
                <div class="wpuf-form-rows">
                    ...
                    <input type="text" class="smallipopInput" name="<?php echo esc_attr( $max_size_name ); ?>"
                           value="<?php echo esc_attr( $max_size_value ); ?>" title="<?php echo esc_attr( $help ); ?>">
                </div> <!-- .wpuf-form-rows -->

                <div class="wpuf-form-rows">
                    <label><?php esc_html_e( 'Max. files', 'wp-user-frontend' ); ?></label>
                    <input type="text" class="smallipopInput" name="<?php echo esc_attr( $max_files_name ); ?>"
                           value="<?php echo esc_attr( $max_files_value ); ?>"
    ...
    public static function recaptcha( $field_id, $label, $values = [] ) {
        ...
        $recaptcha_type_value = isset( $values['recaptcha_type'] ) ? esc_attr(
            $values['recaptcha_type']
        ) : ( ! empty( $values ) ? '' : 'enable_no_captcha' ); ?>
        <li class="custom-field custom_html">
            <?php self::legend( $label, $values, $field_id ); ?>
            ...
            <div class="wpuf-form-holder">
                ...
                <div class="wpuf-form-rows">
                    ...
                    <div class="wpuf-form-sub-fields">
                        <input type="radio" class="smallipopInput" title="reCaptcha type"
                               name="<?php echo esc_attr( $recaptcha_type_name ); ?>"
                               value="invisible_recaptcha" <?php echo $recaptcha_type_value == 'invisible_recaptcha' ? 'checked' : ''; ?> />
                        <?php esc_html_e( 'Enable Invisible reCaptcha', 'wp-user-frontend' ); ?>
                    </div> <!-- .wpuf-form-rows -->
                    <div class="wpuf-form-sub-fields">
                        <input type="radio" class="smallipopInput" title="reCaptcha type"
                               name="<?php echo esc_attr( $recaptcha_type_name ); ?>"
                               value="enable_no_captcha" <?php echo $recaptcha_type_value == 'enable_no_captcha' ? 'checked' : ''; ?> />
